...
class Movie(models.Model):
    ...
    years = models.PositiveSmallIntegerField("Дата выхода", default=2023)
    country = models.CharField("Страна", max_length=30)
    directors = models.ManyToManyField(Actor, verbose_name="режиссёр", related_name="films_director")
    actors = models.ManyToManyField(Actor, verbose_name="актёры", related_name="film_actor")
    genres = models.ManyToManyField(Genre, verbose_name="жанры")
    world_primere = models.DateField("Примера в мире", default=2023)
